...
describe("E2E - Simple transaction", function() {
   ...
   it("Create several business units", function (done) {
     Rx.Observable.from([
       ...
       .subscribe(evt => {}, error => {
           ...
           console.log("[[################ 04 ################ Create several business units DONE ]]");
           return done();
         });
   });
  ...
  */
  ...
  describe("Create five hundred thousand AFCC reloads and check its transactions", function () {
    ...
    it("Create ten thousand AFCC reloads", function (done) {
      ...
      const clearingCreator = function (qty, delay) {
        return Rx.Observable.range(0, qty)
          .concatMap((i) => broker.send$('Events', '', {
            ...
            .do(() => console.log(`CLEARINGS ${i} of ${qty}`))
            .delay(delay)
          )
      };

      const timesToMakeReload = 25000;
    ...
    it('Check all transactions amounts', function (done) {
      ...
      const transactionsExpected = { 
        "123456789_Metro_med": 3216025000,
        "123456789_Gana": 19590000,
        "123456789_NebulaE_POS": 22038750, 
        "123456789_PlaceToPay": 3340250,
        "123456789_NebulaE": 4002000,
        "123456789_surplus": 4000,
        "total": 3265000000
      };

      const collection = mongoDB.client.db(dbName).collection('Transactmoions');
      const expectedTransactions = 2400000;
      let count = 0;
  ...
  //     this.timeout(7200000); 
  //     const acumulatedTransactionAmountExpected = 3265000000;
  //     const transactionsExpected = { 
  //       "123456789_Metro_med": 3216025000,
  //       "123456789_Gana": 19590000,
  //       "123456789_NebulaE_POS": 22038750, 
