...
@Component({
  selector: 'app-settlement-errors',
  templateUrl: './settlement-errors.component.html',
  styleUrls: ['./settlement-errors.component.scss'],
  animations: [
    ...
    refreshTable(){
      this.subscriptions.push(
        Rx.Observable.defer(() =>
          ...
          .pipe(
            mergeMap(paginator => this.acssService.getSettlementErrors$(
              paginator.pageIndex,
              paginator.pageSize
            )),
            ...
            mergeMap(clearingErrors => this.acssService.getSettlementErrorsCount$()
